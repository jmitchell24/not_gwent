...
// *** auto-generated by ledit ***
    card_picker.cancel             = rect( 645.000f,  537.333f,  977.600f,  604.000f);
    card_picker.cards              = rect( 235.400f,  259.667f, 1044.600f,  460.333f);
    card_picker.confirm            = rect( 302.400f,  537.333f,  635.000f,  604.000f);
    card_picker.title              = rect( 275.400f,   89.000f, 1004.600f,  209.667f);
// *** auto-generated by ledit ***
...
#define TRY_GET_RECT(x_) BOX_EDITOR_CARDPICKER.tryGetBorder(#x_, x_)
        ...
        if (TRY_GET_RECT(card_picker.cards)) {}
        if (TRY_GET_RECT(card_picker.title)) {}
        if (TRY_GET_RECT(card_picker.confirm)) {}
        if (TRY_GET_RECT(card_picker.cancel)) {}
