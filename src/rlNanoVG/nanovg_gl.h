...
#define NANOVG_GL_USE_STATE_CLEANUP (1)
...
struct GLNVGcontext {
    ...
    #if NANOVG_GL_USE_STATE_CLEANUP
    GLuint          previous_boundTexture;
    GLuint          previous_stencilMask;
    GLenum          previous_stencilFunc;
    GLint           previous_stencilFuncRef;
    GLuint          previous_stencilFuncMask;
    GLNVGblend      previous_blendFunc;
    #endif
...
static void glnvg__renderFlush(void* uptr)
{
	...
	if (gl->ncalls > 0) {
        ...
        glGetIntegerv(GL_BLEND_SRC_RGB  , (GLint*)&gl->previous_blendFunc.srcRGB);
        glGetIntegerv(GL_BLEND_DST_RGB  , (GLint*)&gl->previous_blendFunc.dstRGB);
        glGetIntegerv(GL_BLEND_SRC_ALPHA, (GLint*)&gl->previous_blendFunc.srcAlpha);
        glGetIntegerv(GL_BLEND_DST_ALPHA, (GLint*)&gl->previous_blendFunc.dstAlpha);
    ...
    glnvg__blendFuncSeparate(gl, &gl->previous_blendFunc);
